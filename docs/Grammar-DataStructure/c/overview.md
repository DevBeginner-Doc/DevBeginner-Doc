...
| \\0          | 空字符     |
  ...
  <table style="margin: 0 auto; text-align: center;">
    <tr>
      <th style="padding: 10px 30px; line-height: 1;">转义字符</th>
      <th style="padding: 10px 30px; line-height: 1;">含义</th>
    </tr>
    <tr>
      <td style="padding: 10px 30px; line-height: 1;">\n</td>
      <td style="padding: 10px 30px; line-height: 1;">换行</td>
    </tr>
    <tr>
      <td style="padding: 10px 30px; line-height: 1;">\"</td>
      <td style="padding: 10px 30px; line-height: 1;">双引号</td>
    </tr>
    <tr>
      <td style="padding: 10px 30px; line-height: 1;">\'</td>
      <td style="padding: 10px 30px; line-height: 1;">单引号</td>
    </tr>
    <tr>
      <td style="padding: 10px 30px; line-height: 2;">\\</td>
      <td style="padding: 10px 30px; line-height: 2;">一个反斜杠<br>(\是反斜杠，/是斜杠)</td>
    </tr>
    <tr>
      <td style="padding: 10px 30px; line-height: 1;">\t</td>
      <td style="padding: 10px 30px; line-height: 1;">制表符</td>
    </tr>
